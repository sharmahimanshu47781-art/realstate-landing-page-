...
const heroData = heroDataRaw as HeroData;
        ...
        <div className="md:w-1/2 mt-12 md:mt-0 relative w-full h-[600px]">
          <div className="absolute top-10 right-10 z-20">
            <div className="bg-blue-600/90 backdrop-blur-md text-white p-6 rounded-xl shadow-2xl">
              <p className="text-sm font-medium text-blue-100 mb-1">{heroData.priceInfo.label}</p>
              <p className="text-3xl font-bold">{heroData.priceInfo.value}</p>
            </div>
          </div>
          <img 
